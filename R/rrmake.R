...
#' @rdname find_root_file
#' @export
find_rstudio_root_file <- make_find_root_file(has_file(glob2rx("*.Rproj"), contents = "^Version: ", n = 1L))

#' @rdname find_root_file
#' @export
find_package_root_file <- make_find_root_file(has_file(glob2rx("DESCRIPTION"), contents = "^Package: ", n = 1L))
