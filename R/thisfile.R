...
#'
#' \R does not store nor export the path of the currently running script.  This is an attempt to circumvent this limitation
#'   by applying heuristics (such as call stack and argument inspection) that work in many cases.
#' **CAVEAT**: Use this function only if your workflow does not permit other solution:
#' if a script needs to know its location, it should be set outside the context of the script if possible.
#'
