...
If you are sure that it is somewhere below your project's root,
...
If the current working directory can be outside of your project,
...
Note that `root_file()` is a *function* that will find files below your root:
