...
dir(find_root(has_file(glob2rx("DESCRIPTION"))))

# Find a file relative to the root
file.exists(find_root_file("R", "root.R", criterion = has_file(glob2rx("DESCRIPTION"))))
```
...
R <- make_find_root_file(has_file(glob2rx("LICENSE")))
R
...
F <- make_fix_root_file(has_file(glob2rx("DESCRIPTION")))
