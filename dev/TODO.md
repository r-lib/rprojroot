...
[`usethis::use_lifecycle_badge()`](https://usethis.r-lib.org/reference/badges.html)
...
Ensure that dependency between source files is cycle-free, as in
<https://github.com/yonicd/foreman/issues/2>
