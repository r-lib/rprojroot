...
- [`thisfile()`](https://rprojroot.r-lib.org/reference/thisfile.md) and
  related functions are soft-deprecated, now available in the whereami
  package ([\#43](https://github.com/r-lib/rprojroot/issues/43)).
...
- New [`thisfile()`](https://rprojroot.r-lib.org/reference/thisfile.md),
  moved from kimisc
...
- S3 class `root_criterion`:
  ...
  - [`as.root_criterion()`](https://rprojroot.r-lib.org/reference/deprecated.md)
  - [`is.root_criterion()`](https://rprojroot.r-lib.org/reference/deprecated.md)
  - [`has_file()`](https://rprojroot.r-lib.org/reference/root_criterion.md)
  - [`has_file_pattern()`](https://rprojroot.r-lib.org/reference/root_criterion.md)
  - Built-in criteria:
    - `is_r_package`
