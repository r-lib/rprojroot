...
vignettes using the
[`thisfile()`](https://rprojroot.r-lib.org/reference/thisfile.md)
function:
...
The [`find_root()`](https://rprojroot.r-lib.org/reference/find_root.md)
...
```
    ...
    ##  [1] "_pkgdown.yml"     "codecov.yml"      "cran-comments.md"
    ##  [4] "DESCRIPTION"      "index.md"         "inst"            
    ##  [7] "LICENSE"          "LICENSE.md"       "man"             
    ## [10] "NAMESPACE"        "NEWS.md"          "R"               
    ## [13] "README.md"        "README.Rmd"       "revdep"          
    ## [16] "rprojroot.Rproj"  "tests"            "TODO.md"         
    ## [19] "vignettes"
